using ASP.NET_Core_Web_API__Task_3_.Formatters;
using ASP.NET_Core_Web_API__Task_3_.Interfaces;
using ASP.NET_Core_Web_API__Task_3_.Services;
...
namespace ASP.NET_Core_Web_API__Task_3_
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c =>
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ASP.NET_Core_Web_API__Task_3_ v1"));
            }
